...
#include "def.h"
	...
	implicit none
     	...
     	real*8 d1,d2,d3,d4
	integer i,j,k,m
	!open(923,file='check3.txt',status='unknown',position='append')
     	if (i .le. nop1) then
      		ncim1=i+chnln1-1
      		ncai=i-chnln1
   	else
	...
	if (m==3) then
       		rating = 10.d0
		if (extra_repuls(i,2).eq.extra_repuls(j,2)) then
			rating = 12.d0
		endif
   	else
        	rating = 11.d0
      	endif
	!write(923,'(i17,6i6,5f17.5)') coll, i, j, ncaj, nnjp1, ncai, ncim1, (d1-shder_dist1), (d2-shder_dist2), (d3-shder_dist3), (d4-shder_dist4), rating
    	return
